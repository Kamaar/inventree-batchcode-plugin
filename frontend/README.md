# Batch Code Generator- Frontend Code

This directory contains the frontend code for the Batch Code Generator plugin.
...
This will compile the frontend into the `../batchcode_plugin/static` directory (ready for distribution).
